...
#define FREQ 16000000UL  // or whatever your MCU clock is

#define TIMER_DIV12_VALUE_100us  (65536 - (FREQ/12/10000))  // 100us -> 10kHz
#define TIMER_DIV12_VALUE_1ms    (65536 - (FREQ/12/1000))   // 1ms -> 1kHz
#define TIMER_DIV12_VALUE_10ms   (65536 - (FREQ/12/100))    // 10ms -> 100Hz
#define TIMER_DIV4_VALUE_500us   (65536 - (FREQ/4/2000))    // 500us -> 2kHz
#define TIMER_DIV128_VALUE_100ms (65536 - (FREQ/128/10))    // 100ms -> 10Hz
#define TIMER_DIV4_VALUE_10us    (65536 - (FREQ/4/100000))  // 10us -> 100kHz
